...
- **Technical chops.** Architecture, deploys, and production troubleshooting across Linux, macOS, and Windows, plus M365/Entra, AWS, Azure, and GCP.
- **Dependable communication.** Twenty years of writing — documentation, runbooks, and published prose — means my ticket notes and customer replies are crystal clear.
...
Writing, graphic design, songwriting, poetry, performance. It keeps me happy.
